...
-- Records of sb_menu
-- ----------------------------
INSERT INTO `sb_menu` VALUES ('1', '/dba/**');
INSERT INTO `sb_menu` VALUES ('2', '/admin/**');
INSERT INTO `sb_menu` VALUES ('3', '/user/**');

-- ----------------------------
-- Table structure for sb_menu_role
-- ----------------------------
DROP TABLE IF EXISTS `sb_menu_role`;
CREATE TABLE `sb_menu_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of sb_menu_role
-- ----------------------------
INSERT INTO `sb_menu_role` VALUES ('1', '1', '1');
INSERT INTO `sb_menu_role` VALUES ('2', '2', '2');
INSERT INTO `sb_menu_role` VALUES ('3', '3', '3');